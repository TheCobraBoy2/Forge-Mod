...
public class Model<T extends TriceratopsEntity> extends HierarchicalModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(FirstMod.MOD_ID, "triceratops"), "main");
    ...
    public void setupAnim(TriceratopsEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.m_267799_(Animations.ANIM_TRICERATOPS_WALKING, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.m_233385_(entity.idleAnimationState, Animations.ANIM_TRICERATOPS_IDLE, ageInTicks, 1f);
    }

    private void applyHeadRotation(float pNetHeadYaw, float pHeadPitch) {
        pNetHeadYaw = Mth.clamp(pNetHeadYaw, -30.0F, 03.0F);
